...
Original CSV: Hospice_All_Owners_2025.07.01.csv
Generated on: 2025-07-20 16:57:31
"""
...
def main(env_file_location, csv_file, db_schema_name, table_name, trample):
    ...
    This script was generated by CSViper for the CSV file: Hospice_All_Owners_2025.07.01.csv
    """
    try:
        # Load and validate configuration
        try:
            db_config, db_schema_name, table_name, metadata, encoding = ImportExecutor.load_and_validate_config(
                env_file_location, csv_file, db_schema_name, table_name, 'Hospice_All_Owners_2025.07.01.metadata.json', use_colors=False
            )
        ...
        ImportExecutor.execute_mysql_import(
            ...
            'Hospice_All_Owners_2025.07.01.create_table_mysql.sql', 'Hospice_All_Owners_2025.07.01.import_data_mysql.sql'
        )
