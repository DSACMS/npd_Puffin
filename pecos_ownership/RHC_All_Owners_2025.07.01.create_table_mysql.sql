...
CREATE TABLE REPLACE_ME_DB_NAME.REPLACE_ME_TABLE_NAME (
    ...
    `first_name_owner` VARCHAR(24),
    `middle_name_owner` VARCHAR(18),
    `last_name_owner` VARCHAR(21),
    `title_owner` VARCHAR(36),
    `organization_name_owner` VARCHAR(71),
    `doing_business_as_name_owner` VARCHAR(67),
    `address_line_1_owner` VARCHAR(52),
    `address_line_2_owner` VARCHAR(51),
    `city_owner` VARCHAR(22),
    ...
    `private_equity_company_owner` VARCHAR(1),
