...
def execute_mysql_import(db_config, db_schema_name, table_name, csv_file, trample):
    ...
    # Load SQL files
    create_table_sql = load_sql_file('npidata_pfile_20050523-20250608.create_table_mysql.sql')
    import_data_sql = load_sql_file('npidata_pfile_20050523-20250608.import_data_mysql.sql')
...
@click.option('--db_schema_name', required=True,
              help='Database schema/database name')
