...
SET
    ...
    `trust_or_trustee_owner` = NULLIF(@trust_or_trustee_owner, ''),
    `other_type_owner` = NULLIF(@other_type_owner, ''),
    `other_type_text_owner` = NULLIF(@other_type_text_owner, ''),
    `parent_company_owner` = NULLIF(@parent_company_owner, ''),
