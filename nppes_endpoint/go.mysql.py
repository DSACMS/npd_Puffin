...
Generated on: 2025-06-23 02:13:36
"""
...
def execute_mysql_import(db_config, db_schema_name, table_name, csv_file, trample):
    ...
    # Load SQL files
    create_table_sql = load_sql_file('endpoint_pfile_20050523-20250608.create_table_mysql.sql')
    import_data_sql = load_sql_file('endpoint_pfile_20050523-20250608.import_data_mysql.sql')
...
def main(env_file_location, csv_file, db_schema_name, table_name, trample):
    ...
    try:
        ...
        script_dir = os.path.dirname(os.path.abspath(__file__))
        metadata_file = os.path.join(script_dir, 'endpoint_pfile_20050523-20250608.metadata.json')
