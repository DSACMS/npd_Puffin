#!/usr/bin/env python3
"""
Fixes the npi as varchar import for Endpoint table
"""
...
def main():
    ...
    #endpoint_table = 'endpoint_file_small' # For testing
    endpoint_table = 'endpoint_file' # for production

    endpoint_DBTable = DBTable(schema='nppes_raw', table=endpoint_table)
...
CREATE INDEX idx_npi_endpoint ON {endpoint_DBTable} (npi);
"""
