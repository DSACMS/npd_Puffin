...
Generated on: 2025-07-19 16:25:49
"""
    ...
    try:
        ...
        try:
            db_config, db_schema_name, table_name, metadata, encoding = ImportExecutor.load_and_validate_config(
                env_file_location, csv_file, db_schema_name, table_name, 'npidata_pfile_20050523-20250608.metadata.json', use_colors=False
            )
        ...
        ImportExecutor.execute_mysql_import(
            ...
            csv_file=csv_file,
            trample=trample,
            create_table_sql_file='npidata_pfile_20050523-20250608.create_table_mysql.sql',
            import_data_sql_file='npidata_pfile_20050523-20250608.import_data_mysql.sql'
        )
