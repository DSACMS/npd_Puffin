...
Original CSV: nucc_parent_code.csv
Generated on: 2025-07-14 12:19:46
"""
...
def main(env_file_location, csv_file, db_schema_name, table_name, trample):
    ...
    This script was generated by CSViper for the CSV file: nucc_parent_code.csv
    """
    try:
        # Load and validate configuration
        try:
            db_config, db_schema_name, table_name, metadata, encoding = ImportExecutor.load_and_validate_config(
                env_file_location, csv_file, db_schema_name, table_name, 'nucc_parent_code.metadata.json', use_colors=False
            )
        ...
        ImportExecutor.execute_mysql_import(
            ...
            csv_file=csv_file,
            trample=trample,
            create_table_sql_file='nucc_parent_code.create_table_mysql.sql',
            import_data_sql_file='nucc_parent_code.import_data_mysql.sql'
        )
