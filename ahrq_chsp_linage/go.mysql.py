...
Original CSV: chsp-hospital-linkage-2023.csv
Generated on: 2025-07-20 13:30:51
"""
...
def main(env_file_location, csv_file, db_schema_name, table_name, trample):
    ...
    This script was generated by CSViper for the CSV file: chsp-hospital-linkage-2023.csv
    """
    try:
        # Load and validate configuration
        try:
            db_config, db_schema_name, table_name, metadata, encoding = ImportExecutor.load_and_validate_config(
                env_file_location, csv_file, db_schema_name, table_name, 'chsp-hospital-linkage-2023.metadata.json', use_colors=False
            )
        ...
        ImportExecutor.execute_mysql_import(
            ...
            'chsp-hospital-linkage-2023.create_table_mysql.sql', 'chsp-hospital-linkage-2023.import_data_mysql.sql'
        )
