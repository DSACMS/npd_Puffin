...
Original CSV: PPEF_Enrollment_Extract_2025.04.01.csv
Generated on: 2025-07-15 02:47:50
"""
...
def main(env_file_location, csv_file, db_schema_name, table_name, trample):
    ...
    This script was generated by CSViper for the CSV file: PPEF_Enrollment_Extract_2025.04.01.csv
    """
    try:
        # Load and validate configuration
        try:
            db_config, db_schema_name, table_name, metadata, encoding = ImportExecutor.load_and_validate_config(
                env_file_location, csv_file, db_schema_name, table_name, 'PPEF_Enrollment_Extract_2025.04.01.metadata.json', use_colors=False
            )
        ...
        ImportExecutor.execute_mysql_import(
            ...
            csv_file=csv_file,
            trample=trample,
            create_table_sql_file='PPEF_Enrollment_Extract_2025.04.01.create_table_mysql.sql',
            import_data_sql_file='PPEF_Enrollment_Extract_2025.04.01.import_data_mysql.sql'
        )
