...
python pecos_enrollment/go.postgresql.py --csv_file /Users/ftrotter/Downloads/Medicare_Fee-For-Service_Public_Provider_Enrollment/2025-Q1/PPEF_Reassignment_Extract_2025.04.01.csv --db_schema_name=pecos_raw --table_name=pecos_reassignment
