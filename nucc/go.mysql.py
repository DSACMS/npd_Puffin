...
Original CSV: merged_nucc_data.csv
...
def main(env_file_location, csv_file, db_schema_name, table_name, trample):
    ...
    This script was generated by CSViper for the CSV file: merged_nucc_data.csv
    """
    try:
        # Load and validate configuration
        try:
            db_config, db_schema_name, table_name, metadata, encoding = ImportExecutor.load_and_validate_config(
                env_file_location, csv_file, db_schema_name, table_name, 'merged_nucc_data.metadata.json', use_colors=False
            )
        ...
        ImportExecutor.execute_mysql_import(
            ...
            csv_file=csv_file,
            trample=trample,
            create_table_sql_file='merged_nucc_data.create_table_mysql.sql',
            import_data_sql_file='merged_nucc_data.import_data_mysql.sql'
        )
