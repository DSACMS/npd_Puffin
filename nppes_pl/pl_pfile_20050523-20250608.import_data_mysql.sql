...
IGNORE 1 LINES
(
    @npi, @provider_secondary_practice_address_address_line_1, @provider_secondary_practice_address_address_line_2, @provider_secondary_practice_address_city_name, @provider_secondary_practice_address_state_name, @provider_secondary_practice_address_postal_code, @provider_secondary_practice_address_country_code_if, @provider_secondary_practice_address_telephone_numbe, @provider_secondary_practice_address_telephone_exten, @provider_practice_address_fax_number
)
SET
    `npi` = NULLIF(@npi, ''),
