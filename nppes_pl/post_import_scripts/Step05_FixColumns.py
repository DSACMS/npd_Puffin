#!/usr/bin/env python3
"""
Fixes the npi as varchar import for PL table
"""
...
def main():
    ...
    #pl_table = 'pl_file_small' # For testing
    pl_table = 'pl_file' # for production

    pl_DBTable = DBTable(schema='nppes_raw', table=pl_table)
...
CREATE INDEX idx_npi_pl ON {pl_DBTable} (npi);
"""
