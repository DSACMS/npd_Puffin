...
Original CSV: clean_npi_to_org_fhir_url.csv
Generated on: 2025-07-08 18:21:18
"""
...
def main(env_file_location, csv_file, db_schema_name, table_name, trample):
    ...
    This script was generated by CSViper for the CSV file: clean_npi_to_org_fhir_url.csv
    """
    try:
        # Load and validate configuration
        try:
            db_config, db_schema_name, table_name, metadata, encoding = ImportExecutor.load_and_validate_config(
                env_file_location, csv_file, db_schema_name, table_name, 'clean_npi_to_org_fhir_url.metadata.json', use_colors=False
            )
        ...
        ImportExecutor.execute_mysql_import(
            ...
            csv_file=csv_file,
            trample=trample,
            create_table_sql_file='clean_npi_to_org_fhir_url.create_table_mysql.sql',
            import_data_sql_file='clean_npi_to_org_fhir_url.import_data_mysql.sql'
        )
