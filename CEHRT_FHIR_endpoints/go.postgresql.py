    ...
    try:
        ...
        try:
            db_config, db_schema_name, table_name, metadata, encoding = ImportExecutor.load_and_validate_config(
                env_file_location, csv_file, db_schema_name, table_name, 'clean_npi_to_org_fhir_url.metadata.json'
            )
        ...
        ImportExecutor.execute_postgresql_import(
            ...
            csv_file=csv_file,
            trample=trample,
            create_table_sql_file='clean_npi_to_org_fhir_url.create_table_postgres.sql',
            encoding=encoding,
